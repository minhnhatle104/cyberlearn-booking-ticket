				...
				<div className="mt-12">
					<div>
						<div>
							...
							<input name="taiKhoan" className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" 
							placeholder="Enter account" onChange={formik.handleChange}/>
						</div>
						<div className="mt-8">
						...
						cursor-pointer">
							...
							<input name='matKhau' className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" 
							type="password" placeholder="Enter your password" onChange={formik.handleChange}/>
						</div>
						<div className="mt-10">
							<button onClick={formik.handleSubmit} className="bg-indigo-500 text-gray-100 p-4 w-full rounded-full tracking-wide
